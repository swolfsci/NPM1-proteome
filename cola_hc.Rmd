...
res_rh = npm1_hierarchical_partitioning_out
```
...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 897))', 'n_signatures \u2265 897', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1837))', 'n_signatures \u2265 1837', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 3519))', 'n_signatures \u2265 3519', prefix = 'collect-classes-from-hierarchical-partition')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 897))', 'n_signatures \u2265 897', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1837))', 'n_signatures \u2265 1837', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 3519))', 'n_signatures \u2265 3519', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
```{r top-rows-heatmap, fig.width = 14, fig.height = 3.5}
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 897),
    method = "UMAP", top_value_method = "SD", top_n = 600, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 897),
    method = "UMAP", top_value_method = "ATC", top_n = 600, scale_rows = TRUE)', 'n_signatures \u2265 897', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1837),
    method = "UMAP", top_value_method = "SD", top_n = 600, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1837),
    method = "UMAP", top_value_method = "ATC", top_n = 600, scale_rows = TRUE)', 'n_signatures \u2265 1837', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 3519),
    method = "UMAP", top_value_method = "SD", top_n = 600, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 3519),
    method = "UMAP", top_value_method = "ATC", top_n = 600, scale_rows = TRUE)', 'n_signatures \u2265 3519', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 897))', 'n_signatures \u2265 897', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 1837))', 'n_signatures \u2265 1837', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 3519))', 'n_signatures \u2265 3519', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 897))', 'n_signatures \u2265 897', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 1837))', 'n_signatures \u2265 1837', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 3519))', 'n_signatures \u2265 3519', prefix = 'test-to-known-factors-from-hierarchical-partition')
